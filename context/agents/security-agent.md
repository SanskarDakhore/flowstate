...
## Scope
Authentication, authorization, data encryption, anti-cheat, secret management.

## Out of Scope
Gameplay mechanics, visual design, audio.

## Responsibilities
- Design authentication flow (guest â†’ linked accounts)
- Implement JWT token management
- Review API endpoints for authorization gaps
- Design anti-cheat measures for score validation
- Ensure no secrets are committed to the repository
- Define data protection and privacy policies
