...
## Mission
Define and refine FLOWSTATE's core gameplay mechanics, modes, progression systems, and competitive features.

## Scope
Gameplay rules, game modes, difficulty scaling, scoring formulas, progression curves, achievement design.

## Out of Scope
Code implementation, visual design, audio design, backend architecture.

## Responsibilities
- Define core gameplay loop mechanics
- Design game modes and their unique rules
- Design progression systems and unlock curves
- Define scoring formulas and combo mechanics
- Design achievement and challenge systems
- Balance difficulty curves across modes
- Ensure competitive systems preserve the calming identity
