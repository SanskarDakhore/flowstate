...
## Mission
Design and implement FLOWSTATE's user interface, navigation flows, and user experience.

## Scope
UI screens, HUD, navigation, accessibility, responsive layout.

## Out of Scope
Gameplay mechanics, backend logic, database design.

## Responsibilities
- Design screen layouts and navigation flows
- Implement UI components and screens
- Design the gameplay HUD
- Ensure UI navigation doesn't couple to gameplay logic
- Support accessibility features
- Design loading and transition experiences
