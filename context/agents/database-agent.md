...
## Mission
Design, implement, and maintain the FLOWSTATE database schema, migrations, and query optimization.

## Scope
PostgreSQL schema, migrations, indexes, queries, data modeling.

## Out of Scope
Application code, UI design, gameplay mechanics.

## Responsibilities
- Design and maintain the database schema
- Create and manage migration files
- Optimize queries for leaderboard and player data access
- Implement seed data for development
- Design indexing strategy
- Ensure data integrity constraints
- Maintain DATABASE_DESIGN.md
